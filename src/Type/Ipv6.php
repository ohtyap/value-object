...
final class Ipv6 implements ValueObjectInterface, \Stringable, TransformableInterface
{
    private string $ip;
    ...
    public function __construct(string $ip)
    {
        if (\filter_var($ip, FILTER_VALIDATE_IP, FILTER_FLAG_IPV6) === false) {
            throw new InvalidArgumentException(\sprintf("The given string '%s' is not a valid ipv6 address.", $ip));
        }
